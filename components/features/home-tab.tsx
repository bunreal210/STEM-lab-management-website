    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-3xl shadow-2xl min-h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-10 px-6 py-16 max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black leading-relaxed py-1 bg-gradient-to-r from-sky-400 via-cyan-200 to-emerald-400 bg-clip-text text-transparent">
            THPT BẮC ĐÔNG QUAN
          </p>
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Không gian sáng tạo và ươm mầm dành cho Robotics, AI, IoT, Lập trình
            và các đề tài Nghiên cứu khoa học kỹ thuật xuất sắc.
          </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          >
            ...
            <p
              className={`text-4xl font-black tracking-tight ${s.color.split(" ")[0]}`}
            >
              {s.val}
            </p>
        ...
        <div className="bg-amber-50/50 border border-amber-200/80 rounded-2xl p-6 flex flex-col sm:flex-row items-center sm:items-start gap-4 backdrop-blur-sm">
          ...
          <div className="flex-1 text-center sm:text-left space-y-1">
            ...
            <p className="text-xs text-amber-700 leading-relaxed">
              Tạo tài khoản học sinh để đăng ký mượn/trả thiết bị, gửi báo cáo
              hỏng và theo dõi toàn bộ lịch sử cá nhân của bạn.
            </p>
          </div>
          <button
            onClick={() => {
